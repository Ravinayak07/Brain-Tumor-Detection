...
model = Model(inputs=[vgg_model.input, resnet_model.input,
              inception_model.input], outputs=predictions)
model.compile(optimizer='adam', loss='categorical_crossentropy',
              metrics=['accuracy'])

# Train the model
#history = model.fit([x_train, x_train, x_train], y_train, epochs=10, batch_size=16)
...
model.save('model_epoch10_batch32_acc95.h5')
